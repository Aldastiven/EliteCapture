...
public class textAdmin {
    ...
    public View textTitulo(String titulo, int size, String orientation){
        ...
        tit.setGravity(AlingText(orientation));
    ...
    public int colorText(String color){
        ...
        switch (color){
            ...
            case "negro":
                ...
                break;
            case "blanco":
                C = Color.parseColor("#F0F3F4");
                break;
            case "azul":
                C = Color.parseColor("#2980B9");
                break;
            default:
