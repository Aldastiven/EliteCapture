    ...
    public Location getLocation() {
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                Log.i("ErrorGps", "no network provider is enabled");
            } else {
                ...
                if (isNetworkEnabled) {
                    ...
                    if (locationManager != null) {
                        ...
                        if (location != null) {
                            ...
                            Log.d("for Network", ""+location.getLongitude()+"¥"+location.getLatitude());
                        }
                    }
                }
                ...
                if (isGPSEnabled) {
                    if (location == null) {
                        ...
                        if (locationManager != null) {
                            ...
                            Log.d("for GPS", ""+location.getLongitude()+"¥"+location.getLatitude());
                        }
                    }
                }
            }
