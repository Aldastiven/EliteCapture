...
public class genated extends AppCompatActivity {
    ...
    public void CrearForm(List<RespuestasTab> questions, String ubicacion) throws Exception {
        ...
        for (RespuestasTab r : questions) {
            ...
            switch (r.getTipo()) {
                case "RS":
                    Cconteos cc = new Cconteos(genated.this, path, ubicacion, r);
                    linearPrinc.addView(cc.Cconteo());
                    break;
                case "RB":
                    CradioButton cb = new CradioButton(genated.this, path, ubicacion, r.getId(), r.getPregunta(), r.getPonderado(), r.getDesplegable(), r);
